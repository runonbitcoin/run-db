 ...
 * indexer.test.js
 *
 * Tests for the IndexerTest
 */

const { describe, it, beforeEach, afterEach } = require('mocha')
const { expect } = require('chai')
const bsv = require('bsv')
const IndexerTest = require('../src/indexer')
...
describe('Indexer', () => {
  it('add and index', async () => {
    const indexer = new IndexerTest(database, api, 'main', 1, 1, logger, 0, Infinity, [])
    await indexer.start()
  ...
  it('index jig sent to pubkey', async () => {
    ...
    const indexer = new IndexerTest(database, api, 'test', 1, 1, logger, 0, Infinity, [])
  ...
  it('mark failed execute as melts', async () => {
    const indexer = new IndexerTest(database, {}, 'test', 1, 1, logger, 0, Infinity, [])
